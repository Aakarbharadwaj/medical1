                                    ...
                                    <div className="col-lg-8">
                                        <div className="p-5">
                                            ...
                                            <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                <div className="col-md-2 col-lg-2 col-xl-2 w-1//5">
                                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-shopping-carts/img5.webp" className="img-fluid rounded-3 w-full" alt="Cotton T-shirt" />
                                                </div>
